defmodule Synthesizer.CatalogTest do
  use Synthesizer.DataCase

  alias Synthesizer.Catalog

  describe "products" do
    alias Synthesizer.Catalog.Product

    import Synthesizer.CatalogFixtures
